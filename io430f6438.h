...
#error io430f6438.h file for use with ICC430/A430 only
#endif
...
__no_init volatile union
{
  unsigned short DAC12_0CTL0;   /* DAC12_0 Control Register 0 */
  ...
  struct
  {
    ...
    unsigned short DAC12OPS        : 1; /* DAC12 Operation Amp. */
  }DAC12_0CTL0_bit;
} @0x0780;
...
__no_init volatile union
{
  unsigned short DAC12_0CTL1;   /* DAC12_0 Control Register 1 */

  struct
  {
    unsigned short DAC12DFJ        : 1; /* DAC12 Data Format Justification */
    unsigned short DAC12OG         : 1; /* DAC12 output buffer gain: 0: 3x gain / 1: 2x gain */
  }DAC12_0CTL1_bit;
} @0x0782;
...
enum {
  ...
  /* DAC12_0 Data */
__no_init volatile unsigned short DAC12_0DAT @ 0x0784;



__no_init volatile union
{
  unsigned short DAC12_0CALCTL;   /* DAC12_0 Calibration Control Register */

  struct
  {
    unsigned short DAC12LOCK       : 1; /* DAC12 Calibration Lock */
  }DAC12_0CALCTL_bit;
} @0x0786;
...
__no_init volatile unsigned short DAC12_0CALDAT @ 0x0788;



__no_init volatile union
{
  unsigned short DAC12_1CTL0;   /* DAC12_1 Control Register 0 */
...
__no_init volatile union
{
  unsigned short DAC12_1CTL1;   /* DAC12_1 Control Register 1 */
...
*/
  ...
  /* DAC12_1 Data */
__no_init volatile unsigned short DAC12_1DAT @ 0x0794;



__no_init volatile union
{
  unsigned short DAC12_1CALCTL;   /* DAC12_1 Calibration Control Register */
...
__no_init volatile unsigned short DAC12_1CALDAT @ 0x0798;



  /* DAC12   Interrupt Vector Word */
__no_init volatile unsigned short DAC12_IV @ 0x079E;
...
__no_init volatile union
{
  unsigned short LCDBCTL0;   /* LCD_B Control Register 0 */

  struct
  {
    unsigned short LCDON           : 1; /* LCD_B LCD On */
    unsigned short                : 1;
    unsigned short LCDSON          : 1; /* LCD_B LCD Segments On */
    unsigned short LCDMX0          : 1; /* LCD_B Mux Rate Bit: 0 */
    unsigned short LCDMX1          : 1; /* LCD_B Mux Rate Bit: 1 */
    unsigned short                : 2;
    unsigned short LCDSSEL         : 1; /* LCD_B Clock Select */
    unsigned short LCDPRE0         : 1; /* LCD_B LCD frequency pre-scaler Bit: 0 */
    unsigned short LCDPRE1         : 1; /* LCD_B LCD frequency pre-scaler Bit: 1 */
    unsigned short LCDPRE2         : 1; /* LCD_B LCD frequency pre-scaler Bit: 2 */
    unsigned short LCDDIV0         : 1; /* LCD_B LCD frequency divider Bit: 0 */
    unsigned short LCDDIV1         : 1; /* LCD_B LCD frequency divider Bit: 1 */
    unsigned short LCDDIV2         : 1; /* LCD_B LCD frequency divider Bit: 2 */
    unsigned short LCDDIV3         : 1; /* LCD_B LCD frequency divider Bit: 3 */
    unsigned short LCDDIV4         : 1; /* LCD_B LCD frequency divider Bit: 4 */
  } LCDBCTL0_bit;

  struct
  {
    unsigned char LCDBCTL0_L;
    unsigned char LCDBCTL0_H;
  };
} @0x0A00;
...
__no_init volatile union
{
  unsigned short LCDBCTL1;   /* LCD_B Control Register 1 */

  struct
  {
    unsigned short LCDFRMIFG       : 1; /* LCD_B LCD frame interrupt flag */
    unsigned short LCDBLKOFFIFG    : 1; /* LCD_B LCD blinking off interrupt flag, */
    unsigned short LCDBLKONIFG     : 1; /* LCD_B LCD blinking on interrupt flag, */
    unsigned short LCDNOCAPIFG     : 1; /* LCD_B No cpacitance connected interrupt flag */
    unsigned short                : 4;
    unsigned short LCDFRMIE        : 1; /* LCD_B LCD frame interrupt enable */
    unsigned short LCDBLKOFFIE     : 1; /* LCD_B LCD blinking off interrupt flag, */
    unsigned short LCDBLKONIE      : 1; /* LCD_B LCD blinking on interrupt flag, */
    unsigned short LCDNOCAPIE      : 1; /* LCD_B No cpacitance connected interrupt enable */
  } LCDBCTL1_bit;

  struct
  {
    unsigned char LCDBCTL1_L;
    unsigned char LCDBCTL1_H;
  };
} @0x0A02;
...
__no_init volatile union
{
  unsigned short LCDBBLKCTL;   /* LCD_B blinking control register */

  struct
  {
    unsigned short LCDBLKMOD0      : 1; /* LCD_B Blinking mode Bit: 0 */
    unsigned short LCDBLKMOD1      : 1; /* LCD_B Blinking mode Bit: 1 */
    unsigned short LCDBLKPRE0      : 1; /* LCD_B Clock pre-scaler for blinking frequency Bit: 0 */
    unsigned short LCDBLKPRE1      : 1; /* LCD_B Clock pre-scaler for blinking frequency Bit: 1 */
    unsigned short LCDBLKPRE2      : 1; /* LCD_B Clock pre-scaler for blinking frequency Bit: 2 */
    unsigned short LCDBLKDIV0      : 1; /* LCD_B Clock divider for blinking frequency Bit: 0 */
    unsigned short LCDBLKDIV1      : 1; /* LCD_B Clock divider for blinking frequency Bit: 1 */
    unsigned short LCDBLKDIV2      : 1; /* LCD_B Clock divider for blinking frequency Bit: 2 */
  } LCDBBLKCTL_bit;

  struct
  {
    unsigned char LCDBBLKCTL_L;
    unsigned char LCDBBLKCTL_H;
  };
} @0x0A04;
...
__no_init volatile union
{
  unsigned short LCDBMEMCTL;   /* LCD_B memory control register */

  struct
  {
    unsigned short LCDDISP         : 1; /* LCD_B LCD memory registers for display */
    unsigned short LCDCLRM         : 1; /* LCD_B Clear LCD memory */
    unsigned short LCDCLRBM        : 1; /* LCD_B Clear LCD blinking memory */
  } LCDBMEMCTL_bit;

  struct
  {
    unsigned char LCDBMEMCTL_L;
    unsigned char LCDBMEMCTL_H;
  };
} @0x0A06;
...
__no_init volatile union
{
  unsigned short LCDBVCTL;   /* LCD_B Voltage Control Register */
  ...
  struct
  {
    unsigned char LCDBVCTL_L;
    unsigned char LCDBVCTL_H;
  };
} @0x0A08;
...
__no_init volatile union
{
  unsigned short LCDBPCTL0;   /* LCD_B Port Control Register 0 */
  ...
  struct
  {
    unsigned char LCDBPCTL0_L;
    unsigned char LCDBPCTL0_H;
  };
} @0x0A0A;
...
__no_init volatile union
{
  unsigned short LCDBPCTL1;   /* LCD_B Port Control Register 1 */
  ...
  struct
  {
    unsigned char LCDBPCTL1_L;
    unsigned char LCDBPCTL1_H;
  };
} @0x0A0C;
...
__no_init volatile union
{
  unsigned short LCDBPCTL2;   /* LCD_B Port Control Register 2 */
  ...
  struct
  {
    unsigned char LCDBPCTL2_L;
    unsigned char LCDBPCTL2_H;
  };
} @0x0A0E;
...
__no_init volatile union
{
  unsigned short LCDBPCTL3;   /* LCD_B Port Control Register 3 */

  struct
  {
    unsigned short LCDS48          : 1; /* LCD Segment 48 enable. */
    unsigned short LCDS49          : 1; /* LCD Segment 49 enable. */
    unsigned short LCDS50          : 1; /* LCD Segment 50 enable. */
  } LCDBPCTL3_bit;

  struct
  {
    unsigned char LCDBPCTL3_L;
    unsigned char LCDBPCTL3_H;
  };
} @0x0A10;
...
__no_init volatile union
{
  unsigned short LCDBCPCTL;   /* LCD_B Charge Pump Control Register 3 */
  ...
  struct
  {
    unsigned char LCDBCPCTL_L;
    unsigned char LCDBCPCTL_H;
  };
} @0x0A12;
...
__no_init volatile unsigned short LCDBIV @ 0x0A1E;
...
__no_init volatile unsigned char LCDBM1 @ 0x0A40;



  /* LCD Blinking Memory 2 */
__no_init volatile unsigned char LCDBM2 @ 0x0A41;



  /* LCD Blinking Memory 3 */
__no_init volatile unsigned char LCDBM3 @ 0x0A42;



  /* LCD Blinking Memory 4 */
__no_init volatile unsigned char LCDBM4 @ 0x0A43;



  /* LCD Blinking Memory 5 */
__no_init volatile unsigned char LCDBM5 @ 0x0A44;



  /* LCD Blinking Memory 6 */
__no_init volatile unsigned char LCDBM6 @ 0x0A45;



  /* LCD Blinking Memory 7 */
__no_init volatile unsigned char LCDBM7 @ 0x0A46;



  /* LCD Blinking Memory 8 */
__no_init volatile unsigned char LCDBM8 @ 0x0A47;
...
__no_init volatile unsigned char LCDBM21 @ 0x0A54;



  /* LCD Blinking Memory 22 */
__no_init volatile unsigned char LCDBM22 @ 0x0A55;



  /* LCD Blinking Memory 23 */
__no_init volatile unsigned char LCDBM23 @ 0x0A56;



  /* LCD Blinking Memory 24 */
__no_init volatile unsigned char LCDBM24 @ 0x0A57;
...
__no_init volatile union
{
  unsigned short LDOKEYPID;   /* LDO Controller peripheral ID and key register */
  struct
  {
    unsigned char LDOKEYPID_L;
    unsigned char LDOKEYPID_H;
  };
} @0x0900;

__no_init volatile union
{
  unsigned short PUCTL;   /* PU Control register */

  struct
  {
    unsigned short PUOUT0          : 1; /* PU - PU Output Signal Bit 0 */
    unsigned short PUOUT1          : 1; /* PU - PU Output Signal Bit 1 */
    unsigned short PUIN0           : 1; /* PU - PU0/DP Input Data */
    unsigned short PUIN1           : 1; /* PU - PU1/DM Input Data */
    unsigned short                : 1;
    unsigned short PUOPE           : 1; /* PU - Port Output Enable */
    unsigned short                : 2;
    unsigned short PUIPE           : 1; /* PU - PHY Single Ended Input enable */
  } PUCTL_bit;

  struct
  {
    unsigned char PUCTL_L;
    unsigned char PUCTL_H;
  };
} @0x0904;
...
__no_init volatile union
{
  unsigned short LDOPWRCTL;   /* LDO Power control register */

  struct
  {
    unsigned short LDOOVLIFG       : 1; /* PU - LDOO Overload Interrupt Flag */
    unsigned short LDOONIFG        : 1; /* PU - LDOI "Coming ON" Interrupt Flag */
    unsigned short LDOOFFIFG       : 1; /* PU - LDOI "Going OFF" Interrupt Flag */
    unsigned short LDOBGVBV        : 1; /* PU - LDO Bandgap and LDOI valid */
    unsigned short                : 1;
    unsigned short OVLAOFF         : 1; /* PU - LDO overload auto off enable */
    unsigned short                : 2;
    unsigned short LDOOVLIE        : 1; /* PU - Overload indication Interrupt Enable */
    unsigned short LDOONIE         : 1; /* PU - LDOI "Coming ON" Interrupt Enable */
    unsigned short LDOOFFIE        : 1; /* PU - LDOI "Going OFF" Interrupt Enable */
    unsigned short LDOOEN          : 1; /* PU - LDO Enable (3.3V) */
  } LDOPWRCTL_bit;

  struct
  {
    unsigned char LDOPWRCTL_L;
    unsigned char LDOPWRCTL_H;
  };
} @0x0908;
